...
- (void)awakeFromNib
{
    ...
    _labelTitle.textColor = [AKThemeManager theme_news_table_cellTitleFontColor] ;

    _labelKind.backgroundColor = [UIColor clearColor] ;
    _labelKind.textColor = [AKThemeManager theme_news_table_cellDescFontColor] ;
    _labelRead.textColor = [AKThemeManager theme_news_table_cellDescFontColor] ;
