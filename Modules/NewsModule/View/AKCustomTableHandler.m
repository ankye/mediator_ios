...
@interface AKCustomTableHandler () <AKBaseTableViewDelegate,BannerCellDelegate>
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (self.handlerDelegate && [self.handlerDelegate respondsToSelector:@selector(didSelectSection:withRow:withContent:)])
    {
        ...
        [self.handlerDelegate didSelectSection:indexPath.section withRow:indexPath.row withContent:aContent];
...
{
    AKCustomTableView* tableCenter = (AKCustomTableView*)self.table;
