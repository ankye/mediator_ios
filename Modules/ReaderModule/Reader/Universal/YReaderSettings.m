...
- (UIColor *)textColor {
    ...
    switch (self.theme) {
        case YReaderThemeNine:
            color = AKRGBColor(149, 147, 143);
            break;
        case YReaderThemeTen:
            color = AKRGBColor(98, 112, 121);
            break;
        default:
            break;
    }
...
- (UIColor *)otherTextColor {
    ...
    switch (self.theme) {
        case YReaderThemeOne:
            color = AKRGBColor(115, 111, 131);
            break;
        case YReaderThemeTwo:
            color = AKRGBColor(121, 104, 74);
            break;
        case YReaderThemeThree:
            color = AKRGBColor(129, 147, 129);
            break;
        case YReaderThemeFour:
            color = AKRGBColor(145, 132, 106);
            break;
        case YReaderThemeFive:
            color = AKRGBColor(145, 132, 106);
            break;
        case YReaderThemeSix:
            color = AKRGBColor(138, 133, 146);
            break;
        case YReaderThemeSeven:
            color = AKRGBColor(146, 139, 152);
            break;
        case YReaderThemeEight:
            color = AKRGBColor(128, 135, 107);
            break;
        case YReaderThemeNine:
            color = AKRGBColor(111, 108, 104);
            break;
        case YReaderThemeTen:
            color = AKRGBColor(59, 78, 87);
            break;
        default:
            break;
    }
