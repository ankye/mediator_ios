...
- (void)setupMain {
    ...
    UIImageView* avatarImageView = [[UIImageView alloc] initWithFrame:CGRectMake(10, CGRectGetMaxY(self.desImageViewRect)+10, 40, 40)];
    ...
    nameLB.frame = CGRectMake(CGRectGetMaxX(avatarImageView.frame) + 10, CGRectGetMaxY(self.desImageViewRect)+10, 0, 0);
    ...
    followButton.frame = CGRectMake(self.view.bounds.size.width - 70, CGRectGetMaxY(self.desImageViewRect)+10, 60, 25);
    ...
    [contentLB mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.mas_equalTo(contentImageView.mas_bottom).offset(45);
    }];
...
-(void)setModel:(XHSHomeModel *)model{
    ...
    [self.avatarImageView sd_setImageWithURL:[NSURL URLWithString:model.url]];
...
-(void)didFinishTransition{
    [self.contentImageView sd_setImageWithURL:[NSURL URLWithString:self.model.url]];
}
@end
