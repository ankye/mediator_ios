...
@interface AKCustomCollectionHandler () <CHTCollectionViewDelegateWaterfallLayout,AKBaseCollectionViewProtocol>
...
-(void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (self.handlerDelegate && [self.handlerDelegate respondsToSelector:@selector(didSelectRow:withContent:)])
    {
        
        UICollectionViewCell* cell = (UICollectionViewCell*)[collectionView cellForItemAtIndexPath:indexPath];

        XHSHomeModel *aContent = nil ;
      
            aContent = self.dataList[indexPath.row] ;
        
        [self.handlerDelegate didSelectRow:cell withContent:aContent] ;
    }
...
- (void)handleDatasourceAndDelegate:(UIView *)table
{
    ...
    {
        ((AKWaterFallView *)table).btDelegate = self ;
